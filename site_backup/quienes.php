...
<!--[if !IE]><!--> <html class="no-legacy-ie no-js" lang="es"  itemscope itemtype="http://schema.org/Organization"> <!--<![endif]-->
    ...
    <body data-spy="scroll" data-target="main">    
		...
		<main class="wrapper public" role="main">
			<div class="container special lazyload box margin-b-100 margin-b-xs-70" id="section1">
				<div class="row">
					

					<div class="col-sm-8 col-xs-9">
						<h1 class="h1 text-color-white margin-b-70" data-item-animate="5">Quiénes <br /> somos</h1>
					</div>
			...
			<div class="container special margin-b-xs-70" id="">
				<div class="row margin-b-200 margin-b-xs-100 box">
					<div class="col-sm-12">

						<div class="block-who hero" data-item-animate="3">
							<div class="img pull-left margin-b-xs-30">
								<img src="img/quienes/alicia.png" class="img xl margin-b-30" alt=""  />
								<div class="display-block text-center"><a href="https://www.linkedin.com/in/aliciachavero/?ppe=1"><span class="icon-linkedin sm"></span></a></div>
							</div>
							<div class="text">
								
								<h3 class="h3 text-color-white margin-b-30 line-height" data-item-animate="5">Soy Alicia Chavero, y para hacer todo esto cuento con un equipo de colaboradores y profesionales que forman la mejor tripulación para navegar en función de cada rumbo.</h3>
				...
				<div class="row margin-b-200 margin-b-xs-100 box" id="section2">
					<div class="col-sm-10 col-sm-offset-2">
						<div class="block-who" data-item-animate="3" >
							
							<div class="img pull-right">
								<img src="img/quienes/inteligencia.png" class="img margin-b-30" alt=""  />
							</div>
							<div class="text">
								
								<div class=" margin-b-30">
									<h3 class="h3 strong text-color-white margin-b-30 line-height" data-item-animate="5">Inteligencia Creativa </h3>
									<p class="text-color-white">Cuando necesitamos reforzar la creatividad y dispararla en su máxima dimensión</p>
								</div>
								<a href="http://www.inteligenciacreativa.com/" class="text-color-white" >Visita su site <span class="icon-arrow-left xxs"></span></a>
					...
					<div class="col-sm-10 col-sm-offset-2">
						<div class="block-who" data-item-animate="3" >
							...
							<div class="img pull-left">
								<img src="img/quienes/joe.png" class="img margin-b-30" alt=""  />
							</div>
							<div class="text">
								
								<div class=" margin-b-30">
									<h3 class="h3 strong text-color-white margin-b-30 line-height" data-item-animate="5">Joe Lozano </h3>
									<p class="text-color-white">Cuando el diseño toma protagonismo y el buen gusto unida a la funcionalidad son imprescindibles para el desarrollo de soluciones</p>
								</div>
								<a class="text-color-white" href="http://joelozano.es/">Visita su site <span class="icon-arrow-left xxs"></span></a>
				...
				<div class="row margin-b-200 margin-b-xs-100 box">
					<div class="col-sm-10 col-sm-offset-2">
						<div class="block-who" data-item-animate="3">
							...
							<div class="img pull-right">
								<img src="img/quienes/bufete.png" class="img margin-b-30" alt=""  />
							</div>
							<div class="text">
								
								<div class=" margin-b-30">
									<h3 class="h3 strong text-color-white margin-b-30 line-height" data-item-animate="5">Bufete de Marketing</h3>
									<p class="text-color-white">Cuando hay que investigar a fondo, y hay que hacerlo con los mejores del mercado. Cuanti, cuali, test usuarios.. no hay nada que no sepan hacer</p>
								</div>
								<a class="text-color-white" href="http://www.bufetedemarketing.com/">Visita su site <span class="icon-arrow-left xxs"></span></a>
				...
				<div class="row margin-b-sm-100 box">
					<div class="col-sm-10 col-sm-offset-2">
						<div class="block-who" data-item-animate="3" >
							
							<div class="img pull-left">
								<img src="img/quienes/nestor.png" class="img margin-b-30" alt=""  />
							</div>
							<div class="text">
								
								<div class=" margin-b-30">
									<h3 class="h3 strong text-color-white margin-b-30 line-height" data-item-animate="5">Nestor Guerra & Co</h3>
									<p class="text-color-white">Cuando entran en juego variables de negocio, diseño de propuestas de valor y aplicación de agile en el desarrollo de soluciones. Néstor es un crack</p>
								</div>
								<a class="text-color-white" href="http://nestorguerra.com/">Visita su site <span class="icon-arrow-left xxs"></span></a>
