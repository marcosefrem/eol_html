...
<!--[if !IE]><!--> <html class="no-legacy-ie no-js" lang="es"  itemscope itemtype="http://schema.org/Organization"> <!--<![endif]-->
    ...
    <body data-spy="scroll" data-target="main">    
					...
					<div class="container special">
						...
						<div class="col-sm-5 nav-site">
							...
							<div class="icons relative margin-b-30">
								<div class="row">
									<div class="col-xs-3"><a href=""><span class="icon-linkedin xs"></span></a></div>
									<div class="col-xs-3"><a href=""><span class="icon-twitter xs"></span></a></div>
								</div>
							</div>
		...
		<main class="wrapper public" role="main">
			...
			<div class="container special lazyload box margin-b-100 margin-b-xs-70" id="section1">
				<div class="row">
					...
					<div class="col-sm-8 col-xs-9">
						<h1 class="h1 text-color-white margin-b-70" data-item-animate="5">Eventos</h1>
						<h2 class="h3 text-color-white margin-b-30 line-height" data-item-animate="5">Aquí tienes el listado de nuestros eventos, por si te animas a venir.</h2>
					</div>
			...
			<div class="container special lazyload box margin-b-xs-70 margin-b-80" id="section2">
				<div class="row margin-b-80">
					<div class="col-sm-12">
						<a href="">
						<div class="block-evento">
							<date>5 may 2017</date>
							<h2 class="h2">UX Fighters</h2>
							<h3 class="h3">Madrid</h2>
