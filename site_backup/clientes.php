...
<!--[if !IE]><!--> <html class="no-legacy-ie no-js" lang="es"  itemscope itemtype="http://schema.org/Organization"> <!--<![endif]-->
    ...
    <body data-spy="scroll" data-target="main">    
		...
		<main class="wrapper public" role="main">
			...
			<div class="container special lazyload box margin-b-100 margin-b-xs-70" id="section1">
				<div class="row">
					...
					<div class="col-sm-8 col-xs-9">
						<h1 class="h1 text-color-white margin-b-70" data-item-animate="5">Clientes</h1>
						<h2 class="h3 light text-color-white margin-b-30 line-height" data-item-animate="5">Trabajamos mano a mano con nuestros clientes sumergiéndonos en su cultura, sus necesidades y su ambición.</h2>
					</div>
			...
			<div class="container lazyload box margin-b-xs-70 margin-b-80" id="section2">
				<div class="row">
					<div class="col-sm-12">
							...
							<ul class="list-logos">
								...
								<li data-item-animate="1"><img src="img/logos/svg/bankinter.svg" alt="Bankinter"></li>
								<li data-item-animate="1"><img src="img/logos/svg/kpmg.svg" alt="KPMG"></li>
								<li data-item-animate="1"><img src="img/logos/svg/microsoft.svg" alt="Microsoft"></li>
								<li data-item-animate="1"><img src="img/logos/svg/ie.svg" alt="Ie"></li>
								<li data-item-animate="1"><img src="img/logos/svg/isdi.svg" alt="Ie"></li>
								<li data-item-animate="1"><img src="img/logos/svg/bankia.svg" alt="Bankia"></li>
								<li data-item-animate="1"><img src="img/logos/svg/elpais.svg" alt="El País"></li>
								<li data-item-animate="1"><img src="img/logos/svg/selfbank.svg" alt="Self Bank"></li>
								<li data-item-animate="1"><img src="img/logos/svg/axa.svg" alt="Axa"></li>
								<li data-item-animate="1"><img src="img/logos/svg/danone.svg" alt="Danone" class="logo-item sm"></li>
								<li data-item-animate="1"><img src="img/logos/svg/uem.svg" alt="UEM"></li>
								<li data-item-animate="1"><img src="img/logos/svg/telepizza.svg" alt="Telepizza"></li>
								<li data-item-animate="1"><img src="img/logos/svg/unicolombia.svg" alt="Universidad de Colombia"></li>
								<li data-item-animate="1"><img src="img/logos/svg/dia.png" alt="Dia"></li>
								<li data-item-animate="1"><img src="img/logos/svg/eoi.svg" alt="Eoi" class="logo-item sm"></li>
								<li data-item-animate="1"><img src="img/logos/svg/redes.svg" alt="Redes"></li>
