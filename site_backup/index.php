							...
							<div class="options" data-option="ponencia">
								...
								<form method="post" action="gracias.php">
									<div class="margin-b-20">
										...
										<input type="text" id="nombre" name="first_name" placeholder="" required=""/>
									</div>
									<div class="clearfix"></div>
									<div class="margin-b-20">
										<label class="h3 text-color-navlink">Email</label>
										<input type="text" id="mail" name="email" placeholder="" required=""/>
									</div>
									<div class="clearfix"></div>
									<div class="margin-b-20">
...
<input type="submit" name="submit" value="Submit">
	...
	-->							
		...
		<main class="wrapper public" role="main">
			...
			<div class="container special lazyload box margin-b-xs-70 section-video" id="section1">
				<div class="row">
					
					<div class="col-sm-3 col-xs-3">
						<img src="img/isotipo.png" alt="Logotipo theCrew" title="Consultoría de Innovación y Diseño" class="logo">
					</div>
					
					<div class="col-sm-9 col-xs-9">
						<h1 class="h1 text-color-white"  data-item-animate="5">Somos una consultora de innovación</h1>
			...
			<div class="section active section-main" id="">
				
				<div class="video-background">
				    <div class="video-foreground">	
		
							<iframe id="ytplayer" src="https://www.youtube.com/embed/yGv6oVrFNAM?controls=0&enablejsapi=1&showinfo=0&rel=0&autoplay=1&loop=1&playlist=yGv6oVrFNAM" frameborder="0" allowfullscreen></iframe>		        
				    </div>
				</div>
			</div>			
			...
			<div class="container special lazyload box margin-b-xs-70 margin-b-sm-70" id="section2">
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="block-text-image">
							...
							<div class="text">
								<div class="margin-b-25">
									<h2 class="h2 text-color-white" data-item-animate="3">Generamos coherencia y valor en las compañías </h2>
								</div>	
								<div class="margin-l-30" >
									<p class="text-color-white margin-b-60 h4 light" data-item-animate="3">Utilizamos diferentes metodologías de innovación que permiten a nuestros clientes desarrollar o mejorar productos, servicios y experiencias. Nuestro trabajo es entender por dónde empezar, diseñar un plan, y ejecutarlo.</p>	

								</div>
								
							</div>
							<div class="" data-item-animate="5">
								<a href="como.php" class="display-inline-block text-color-white underline margin-r-30">Esta es nuestra filosofía <span class="icon-xs icon-arrow-left"></span></a><a href="hacemos.php" class="display-inline-block text-color-white underline">y esta es nuestra puesta en escena <span class="icon-xs icon-arrow-left"></span></a>	

							</div>							
							
							<img src="img/img1.jpg" class="shadow-image absolute-position img-responsive-xs" alt=""  data-left="380"  data-left-sm="380" data-item-animate="5"/>
						</div>
			...
			<div class="separator-section visible-xs"></div>
			<!--
			<div class="container special lazyload box margin-b-xs-70" id="section3">
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="block-text-image right">
							
							
							<div class="text sm">
								<div class="margin-b-60">
									<h2 class="h3 text-color-white" data-item-animate="3">Nuestras dos líneas de trabajo son la consultoría y la formación.</h2>
								</div>	
								<div class="" data-item-animate="5">
									<a href="hacemos.php" class="display-inline-block btn btn-transparent">Cómo lo hacemos</a>	
								</div>
